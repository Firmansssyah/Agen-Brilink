...
interface EditBankFeeModalProps {
    isOpen: boolean;
    onClose: () => void;
...
const EditBankFeeModal: React.FC<EditBankFeeModalProps> = ({ isOpen, onClose, onSave, onDelete, transactionToEdit }) => {
    ...
    return (
        <>
            <div 
                ...
                role="dialog"
                aria-modal="true"
                aria-labelledby="edit-bank-fee-modal-title"
            >
                <div 
                ...
                >
                    <div className="p-6 flex justify-between items-center border-b border-slate-200 dark:border-white/10">
                        <h2 id="edit-bank-fee-modal-title" className="text-xl font-medium text-slate-800 dark:text-white">Edit Potongan Bank</h2>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="p-6 space-y-5">
                             <div>
                                <label htmlFor="amountEdit" className="block text-sm font-medium text-slate-600 dark:text-neutral-300 mb-2">Jumlah Potongan (Rp)</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    id="amountEdit"
...
export default EditBankFeeModal;