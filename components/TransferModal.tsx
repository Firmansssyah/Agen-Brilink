            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <label htmlFor="fromWallet" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-2">Dari Dompet</label>
                            ...
                            <div className="pt-7">
                                <TransferIcon className="h-6 w-6 text-slate-400" />
                            </div>

                            {/* To Wallet */}
                            <div className="flex-1">
                                <label htmlFor="toWallet" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-2">Ke Dompet</label>
                                <div className="relative">
                    ...
                    <div className="px-6 py-4 flex justify-end space-x-3">
                        ...
                        <button type="submit" className="bg-indigo-500 hover:bg-indigo-600 text-white dark:bg-indigo-400 dark:hover:bg-indigo-500 dark:text-slate-900 font-semibold py-2 px-5 rounded-full text-sm transition-colors">Pindahkan</button>
                    </div>
                </form>
            </div>
        </div>
