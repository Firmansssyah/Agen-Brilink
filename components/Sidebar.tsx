...
// Mendefinisikan tipe 'Page' di sini untuk digunakan dalam komponen.
// Ini adalah alternatif jika tipe tidak diimpor dari file terpusat.
export type Page = 'dashboard' | 'management' | 'customers' | 'reports' | 'settings';

// Properti untuk komponen NavLink di dalam Sidebar.
...
/**
 * Komponen NavLink adalah item navigasi individual di dalam Sidebar.
 * Menampilkan ikon dan teks, serta memiliki gaya berbeda jika sedang aktif.
 */
...
/**
 * Komponen Sidebar menyediakan navigasi utama aplikasi untuk tampilan desktop (large screen).
 * (Saat ini komponen ini tidak digunakan dalam layout utama, navigasi ditangani oleh Header).
 */
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-72 bg-transparent h-screen sticky top-0">
            ...
            <div className="flex-1 flex flex-col p-4 space-y-4 overflow-y-auto">
                ...
                <nav className="space-y-2 mt-2">
                 ...
                 {/* Navigasi Tambahan di Bagian Bawah */}
